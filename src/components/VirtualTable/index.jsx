...
export default class ReactVirtualSizeTable extends Component {
  state = {
    scrollLeft: 0,
    scrollTop: 0,
  };
      ...
      for (let j = startRow; j <= endRow; j++) {
        cells.push(
          onCell({
            ...
            style: {
              position: "absolute",
              transform: `translate(${this.cacheWidths[i - 1] || 0}px,${
                j * rowHeight
              }px)`,
              width: this.widths[i],
              height: rowHeight,
  ...
  render() {
    ...
    return (
      <div
        className="react-virtual-size-table"
        onScroll={this.onScroll}
        style={{ width, height, overflow: "scroll" }}
      >
        <div
          className="react-virtual-size-container"
          style={{
            width: totalWidth,
            height: totalHeight,
            position: "relative",
