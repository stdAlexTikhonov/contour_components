...
var handlersToBeBound = {
    ...
    onwheel: function (evt) {
        const prop = evt.ctrlKey == true  ? (this.deltaProp == 'deltaX' ? 'deltaY' : 'deltaX') : this.deltaProp ;
        this.index += 3 * Math.sign(evt[prop]) ;
        evt.stopPropagation();
        evt.preventDefault();
    },
...
/* inject:css */
cssFinBars = 'div.finbar-horizontal,div.finbar-vertical{margin:0px}div.finbar-horizontal>.thumb,div.finbar-vertical>.thumb{background-color:#F5F5F5;-webkit-box-shadow:0 0 1px #000;-moz-box-shadow:0 0 1px #000;box-shadow:0 0 1px #000;border-radius:0px;margin:0px;opacity:1}div.finbar-horizontal>.thumb.hover,div.finbar-vertical>.thumb.hover{opacity:1}div.finbar-vertical{top:0;bottom:0;right:0;width:6px}div.finbar-vertical>.thumb{top:0;right:0;width:6px}div.finbar-horizontal{left:0;right:0;bottom:0;height:6px}div.finbar-horizontal>.thumb{left:0;bottom:0;height:6px}';
/* endinject */
