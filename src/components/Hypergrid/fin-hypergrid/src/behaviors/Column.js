...
Column.prototype = {
    ...
    setWidth: function(width) {
        width = Math.min(Math.max(Math.max(this.properties.minimumColumnWidthAxis || 0) ,this.properties.minimumColumnWidth, width), this.properties.maximumColumnWidth || Infinity);
