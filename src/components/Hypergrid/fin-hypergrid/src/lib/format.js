export default function format(mask, value) {
    ...
    function processValue(value, maskObj) {
        ...
        if (!isNegative && maskObj.maskHasPositiveSign) {
            ...
            valObj.sign = !maskObj.maskHasNegativeSign ?
                "" :
                "-";
        }
    ...
    const valObj = processValue(value, maskObj);
    return (maskObj.prefix + valObj.sign + valObj.result + maskObj.suffix).replace(' ', '\xa0');
}
